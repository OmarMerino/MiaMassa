...
//get agregadoss firebase
app.get('/getAgregados', async (req, res) => {
    try {
...
//añadir agregados 
app.post('/addAgregados', async (req, res) => {
    const data = req.body;
    console.log(data)
...
// Definimos la ruta para eliminar un agregados por su ID
app.delete('/agregados/:id', async (req, res) => {
    try {
      const id = req.params.id;
      ...
      // Creamos una referencia al documento del producto que deseamos eliminar
      const productoRef = agregadosRef.doc(id);
